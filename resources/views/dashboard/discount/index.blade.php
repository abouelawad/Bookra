    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="d-inline-flex card-body">
                <a href="{{ route('dashboard.discount.show', $discount->id) }}" class="btn btn-success btn-sm"><i class="far fa-eye fa-xs" style="color: #292e2c;"></i></a>
                <a href="{{ route('dashboard.discount.edit',$discount->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-edit fa-xs" style="color: #292e2c;"></i></a>
